...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    {
        $adminPermissions = [
            'ads.view', 'ads.manage_all', 'ads.approve', 'ads.reject', 'ads.delete',
        ...
        $adminRolePermissions = [
            ...
            'admin' => ['ads.view', 'ads.manage_all', 'ads.approve', 'ads.reject', 'ads.delete', 'users.view', 'users.verify', 'users.ban', 'reports.view'],
            'financial_manager' => ['finance.view', 'finance.export', 'finance.settle', 'reports.view'],
            'operator' => ['ads.view', 'ads.manage_all', 'ads.approve', 'ads.reject', 'users.view', 'users.verify'],
        ...
        $permissions = [
            ...
            'manage-settings', 'view-logs', 'ads.manage_all',
        ];
        ...
        $rolePermissions = [
            ...
            'admin' => ['manage-banks', 'view-reports', 'manage-users', 'manage-finance', 'review-kyc', 'ads.view', 'ads.manage_all', 'ads.approve', 'ads.reject', 'ads.delete', 'users.view', 'users.verify', 'users.ban', 'reports.view'],
            'operator' => ['approve-ads', 'reject-ads', 'review-kyc', 'ads.view', 'ads.manage_all', 'ads.approve', 'ads.reject', 'users.view', 'users.verify'],
            'auditor' => ['ads.view', 'finance.view', 'reports.view'],
